...
// Main function
async function main() {
  console.log('🖼️ Creating less compressed version for About image...\n');
  ...
  console.log(`\n💡 Recommended less compressed option:`);
  ...
  console.log(`\n💡 Next steps:`);
  console.log(`1. Update About.jsx to use the less compressed file`);
  console.log(`2. Test the visual quality`);
  console.log(`3. If still too compressed, try the 95% quality version`);
}
